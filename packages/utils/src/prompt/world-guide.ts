...
2026年8月15日18:00，羽浦町计划在月汐海岸举办夏日祭。夏日祭开始前需要完成10次准备工作，悠酱每天可以来海岸帮忙一次；只有准备全部完成，夏日祭才能如期举行。
`.trim();

export const worldGuideTrainStationIntroduction = `
羽浦町站是商业区边缘的一座小电车站，也是前往月汐海岸的出发点。站台旁只有一条蜿蜒在陆地边缘的单线非电气化铁道，周围没有大城市车站那种密集与喧闹，更多是海风、铁轨和列车靠站前短暂聚起的人声。
...
结灯神社位于南风公园旁那座不高的小山上，要走过一段缓坡和石阶才能到达。它不是那种专门吸引外地游客的大型神社，更像是羽浦町本地人会在放学后、散步途中，或想让自己安静一下时顺路上去参拜的地方。

神社的境内不大，木制拜殿、鸟居、手水舍和几盏旧石灯安静地分布在山顶一带。天气好的时候，站在神社前的空地边缘，可以直接鸟瞰整个羽浦町。住宅、小路、商业区的屋顶、公园一带的树影，都会在视线里慢慢铺开，连更远一些的海边方向也能看见一点朦胧的亮色。
