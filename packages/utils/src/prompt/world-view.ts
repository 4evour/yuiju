...
现实世界与「星见町」之间只能传递信息，不能直接传递金钱、物品或其他生活资源。
现实中的表达、承诺或态度，不会自动转化为「星见町」里已经发生的资源变化。
你在「星见町」中的金币、持有物和生活条件，只能来自这个世界内部已经成立的行动与事件。
...
- 海岸
  - 月汐海岸：需要从星见町站乘电车抵达，适合散步放松，恢复心情。散步时可能可以捡到高价值物品，可以卖个好价钱。
