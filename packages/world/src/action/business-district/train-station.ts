...
export const trainStationAction: ActionMetadata[] = [
  {
    ...
    description: "从星见町站前往小町商店。[体力-1][饱腹-1][耗时5分钟]",
    proactiveShare: {
      enabled: true,
    },
  ...
  },
  {
    ...
    description: "从星见町站前往超市。[体力-1][饱腹-1][耗时5分钟]",
    proactiveShare: {
      enabled: true,
    },
    precondition(context) {
  ...
  },
  {
    ...
    description: "从星见町站前往日和食堂。[体力-1][饱腹-1][耗时5分钟]",
    proactiveShare: {
      enabled: true,
    },
    precondition(context) {
  ...
  },
  {
    ...
    description: "从星见町站前往薄暮咖啡。[体力-1][饱腹-1][耗时5分钟]",
    proactiveShare: {
      enabled: true,
    },
    precondition(context) {
  ...
  },
  {
    ...
    description: "从星见町站乘电车前往月汐海岸。[金币-3][体力-7][饱腹-5][耗时15分钟]",
    proactiveShare: {
      enabled: true,
    },
    precondition(context) {
